...
class Sort(ABC):
    ...
    @abstractmethod
    def sort(self, ln_struct: Linear_Structure[T], key: Callable, reverse: bool = False) -> None:
        """
    ...
    def sort_and_return(self, ln_struct: Linear_Structure[T], key: Callable, reverse: bool = False) -> any[T]:
        """
